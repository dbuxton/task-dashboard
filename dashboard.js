...
(function() {
  var AUTOREFRESH_HOURS, Card, CardView, Cards, CardsView, CompletedCardView, CompletedCardsView, CustomerRequestsView, GCAL_FEED_URL_LS_KEY, List, Lists, NAME_TO_INITIALS_MAPPING, OverdueCardsView, PIPEDRIVE_API_BASE, PIPEDRIVE_API_KEY_LS_KEY, REFRESH_CARDS_INTERVAL_SECONDS, TRELLO_BOARDS, UnscheduledCardView, UnscheduledCardsView, User, Users, calendarCards, getBoardCards, getHash, getMonday, getPipedriveActivities, handleFeed, loadBoardLists, loadBoards, loadCurrentMember, loadInitialData, loadMembers, refreshPage, setAvatarStyle, trelloLists, trelloUsers, updateCalendar, updateGcal, updatePipedrive;
